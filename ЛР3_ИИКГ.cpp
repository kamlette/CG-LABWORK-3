...
public:
    ...
    bool Init()
    {
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/Камилла/Desktop/images.png");
    ...
    {
        //изменение уровня освещенности при нажатии на клавиши
        switch (Key) {
        case 'q':
            glutLeaveMainLoop();
            break;
...
private:
    ...
    GLuint m_IBO;//указатель на буферный объект для буфера индексов
    LightingTechnique* m_pEffect;
    Texture* m_pTexture;//указатель на текстуру
    Camera* m_pGameCamera;//указатель на камеру
    float m_scale;
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Tutorial 14-19")) {
        return 1;
    }
